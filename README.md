...
Проект находится в папке SqlExample
...
Можно увидеть, что почти все запросы от Burp сваливаются ошибкой 404, а те, которые возвращают код 200 - лишь игнорируют параметр id в запросе из-за неудачной попытки его декодировать, и программа просто возвращает страницу с формой. Таким образом, разработанная система защищена от эксплуатирования SQL инъекций.
